...
const I18N = (function(){
  ...
  const dict = {
    ar: {
      ...
      payment_due_day: "يوم استحقاق الدفع من كل شهر", payment_due_day_hint: "سيتم إصدار فاتورة شهرية تلقائيًا في هذا اليوم من كل شهر طالما العقد ساري.",
      ...
      activity_from: "من تاريخ", activity_to: "إلى تاريخ",
    ...
    en: {
      ...
      payment_due_day: "Monthly payment due day", payment_due_day_hint: "A monthly invoice will be auto-generated on this day of every month while the contract is active.",
      ...
      activity_from: "From date", activity_to: "To date",
